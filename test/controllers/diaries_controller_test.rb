...
class DiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post diaries_url, params: { diary: { feeling: @diary.feeling, note: @diary.note, weather: @diary.weather } }
    end
  ...
  test "should update diary" do
    patch diary_url(@diary), params: { diary: { feeling: @diary.feeling, note: @diary.note, weather: @diary.weather } }
